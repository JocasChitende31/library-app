...
public interface BookRepository extends JpaRepository<Book, Long> {
	...
	@Query(nativeQuery = true, value = """
			...
			tb_books.downloader_ref_pdf AS downloaderRefPDF,
			tb_category.genre,
	...
	@Modifying
	@Query(nativeQuery = true, value = """
			UPDATE tb_books SET title = :newTitle, book_year = :newBook_year, publisher = :newPublisher, edition = :newEdition, img_url = :newImg_url, short_summary = :newShort_summary, long_summary = :newLong_summary, category_id = :newCategory_id, author_id = :newAuthor_id, downloader_ref_pdf = :downloader_ref_pdf
			WHERE tb_books.id = :bookId""")
	void updateBook(Long bookId, String newTitle, String newBook_year, String newPublisher, Integer newEdition,
			String newImg_url, String newShort_summary, String newLong_summary, Long newCategory_id, Long newAuthor_id, String downloader_ref_pdf);
	@Modifying
	@Query(nativeQuery=true, value ="""
